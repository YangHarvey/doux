...
# ./ycsb_bench -k 16 -v 1024 --unlimit_fd -w 2 -e 131072 -n 13107 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_1KB.txt
# ./ycsb_bench -k 16 -v 1024 --unlimit_fd -w 2 -e 131072 -n 13107 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_1KB.txt

# LevelDB 256B
./ycsb_bench -k 16 -v 256 --init_db -e 38550 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rl_256B.txt
./ycsb_bench -k 16 -v 256 -c -w 2 -e 38550 -n 3885 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_256B.txt
./ycsb_bench -k 16 -v 256 -c -w 2 -e 38550 -n 3885 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_256B.txt

./ycsb_bench -k 16 -v 1024 --init_db -e 10082 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rl_1KB.txt
./ycsb_bench -k 16 -v 1024 -c -w 2 -e 10082 -n 1008 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_1KB.txt
./ycsb_bench -k 16 -v 1024 -c -w 2 -e 10082 -n 1008 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_1KB.txt

./ycsb_bench -k 16 -v 4096 --init_db -e 2550 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rl_4KB.txt
./ycsb_bench -k 16 -v 4096 -c -w 2 -e 2550 -n 255 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_4KB.txt
./ycsb_bench -k 16 -v 4096 -c -w 2 -e 2550 -n 255 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_4KB.txt

./ycsb_bench -k 16 -v 16384 --init_db -e 639 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rl_16KB.txt
./ycsb_bench -k 16 -v 16384 -c -w 2 -e 639 -n 64 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_16KB.txt
./ycsb_bench -k 16 -v 16384 -c -w 2 -e 639 -n 64 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_16KB.txt

./ycsb_bench -k 16 -v 65536 --init_db -e 159 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rl_64KB.txt
./ycsb_bench -k 16 -v 65536 -c -w 2 -e 159 -n 16 -d ${LevelDB_DIR} -m 0 -t 3 > ${LevelDB_OUTPUT}/micro_leveldb_rr_64KB.txt
./ycsb_bench -k 16 -v 65536 -c -w 2 -e 159 -n 16 -d ${LevelDB_DIR} -m 0 -t 0 > ${LevelDB_OUTPUT}/micro_leveldb_sr_64KB.txt


# RISE 256B
./ycsb_bench -k 16 -v 256 --init_db -e 38550 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rl_256B.txt
./ycsb_bench -k 16 -v 256 -c -w 2 -e 38550 -n 3885 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rr_256B.txt
./ycsb_bench -k 16 -v 256 -c -w 2 -e 38550 -n 3885 -d ${RISE_DIR} -m 12 -t 0 > ${RISE_OUTPUT}/micro_rise_sr_256B.txt

./ycsb_bench -k 16 -v 1024 --init_db -e 10082 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rl_1KB.txt
./ycsb_bench -k 16 -v 1024 -c -w 2 -e 10082 -n 1008 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rr_1KB.txt
./ycsb_bench -k 16 -v 1024 -c -w 2 -e 10082 -n 1008 -d ${RISE_DIR} -m 12 -t 0 > ${RISE_OUTPUT}/micro_rise_sr_1KB.txt

./ycsb_bench -k 16 -v 4096 --init_db -e 2550 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rl_4KB.txt
./ycsb_bench -k 16 -v 4096 -c -w 2 -e 2550 -n 255 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rr_4KB.txt
./ycsb_bench -k 16 -v 4096 -c -w 2 -e 2550 -n 255 -d ${RISE_DIR} -m 12 -t 0 > ${RISE_OUTPUT}/micro_rise_sr_4KB.txt

./ycsb_bench -k 16 -v 16384 --init_db -e 639 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rl_16KB.txt
./ycsb_bench -k 16 -v 16384 -c -w 2 -e 639 -n 64 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rr_16KB.txt
./ycsb_bench -k 16 -v 16384 -c -w 2 -e 639 -n 64 -d ${RISE_DIR} -m 12 -t 0 > ${RISE_OUTPUT}/micro_rise_sr_16KB.txt

./ycsb_bench -k 16 -v 65536 --init_db -e 159 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rl_64KB.txt
./ycsb_bench -k 16 -v 65536 -c -w 2 -e 159 -n 16 -d ${RISE_DIR} -m 12 -t 3 > ${RISE_OUTPUT}/micro_rise_rr_64KB.txt
./ycsb_bench -k 16 -v 65536 -c -w 2 -e 159 -n 16 -d ${RISE_DIR} -m 12 -t 0 > ${RISE_OUTPUT}/micro_rise_sr_64KB.txt
...
# # Seq Load
# # LevelDB
# ./ycsb_bench -k 16 -v 64 --init_db -e 131072 -d ${LevelDB_DIR} -m 0 -t 0 > ../eval/ycsb_leveldb_sl_64B.txt
