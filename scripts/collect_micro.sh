...
echo '===== Random Load ====='
echo 'LevelDB:'
cat ycsb_leveldb_rl_64B.txt | grep 'Timer 16 MEAN'
cat ycsb_leveldb_rl_256B.txt | grep 'Timer 16 MEAN'
cat ycsb_leveldb_rl_1KB.txt | grep 'Timer 16 MEAN'
cat ycsb_leveldb_rl_4KB.txt | grep 'Timer 16 MEAN'
cat ycsb_leveldb_rl_16KB.txt | grep 'Timer 16 MEAN'
cat ycsb_leveldb_rl_64KB.txt | grep 'Timer 16 MEAN'

echo 'WiscKey:'
cat ycsb_wisckey_rl_64B.txt | grep 'Timer 16 MEAN'
cat ycsb_wisckey_rl_256B.txt | grep 'Timer 16 MEAN'
cat ycsb_wisckey_rl_1KB.txt | grep 'Timer 16 MEAN'
cat ycsb_wisckey_rl_4KB.txt | grep 'Timer 16 MEAN'
cat ycsb_wisckey_rl_16KB.txt | grep 'Timer 16 MEAN'
cat ycsb_wisckey_rl_64KB.txt | grep 'Timer 16 MEAN'

echo 'DiffKV:'
cat ycsb_diffkv_rl_64B.txt | grep 'Timer 16 MEAN'
cat ycsb_diffkv_rl_256B.txt | grep 'Timer 16 MEAN'
cat ycsb_diffkv_rl_1KB.txt | grep 'Timer 16 MEAN'
cat ycsb_diffkv_rl_4KB.txt | grep 'Timer 16 MEAN'
cat ycsb_diffkv_rl_16KB.txt | grep 'Timer 16 MEAN'
cat ycsb_diffkv_rl_64KB.txt | grep 'Timer 16 MEAN'

echo 'Doux:'
cat ycsb_doux_rl_64B.txt | grep 'Timer 16 MEAN'
cat ycsb_doux_rl_256B.txt | grep 'Timer 16 MEAN'
cat ycsb_doux_rl_1KB.txt | grep 'Timer 16 MEAN'
cat ycsb_doux_rl_4KB.txt | grep 'Timer 16 MEAN'
cat ycsb_doux_rl_16KB.txt | grep 'Timer 16 MEAN'
cat ycsb_doux_rl_64KB.txt | grep 'Timer 16 MEAN'
