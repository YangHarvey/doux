...
# TPC-H Q6
# LevelDB
./tpch_bench_3 --init_db -t 6 -f $lineitem1 -m 0 -i 5 -v 64 -d $LevelDB_DIR > $LevelDB_OUTPUT/tpch_q6_value64.txt
# LevelDB(SI)
./tpch_bench_3 --init_db --si -t 6 -f $lineitem1 -m 0 -i 5 -v 64 -d $LevelDB_DIR > $LevelDB_SI_OUTPUT/tpch_q6_value64.txt
# RISE(DSI)
./tpch_bench_3 --init_db --si -t 6 -f $lineitem1 -m 12 -i 5 -v 64 -d $LevelDB_DIR > $RISE_OUTPUT/tpch_q6_value64.txt
